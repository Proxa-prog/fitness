...
var buttonBack = document.querySelector('.treners__button-back');
var buttonForward = document.querySelector('.treners__button-forward');
var slides = document.querySelectorAll('.treners__item');
var slideIndex = 0; // ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_treners_carousel__WEBPACK_IMPORTED_MODULE_4__["default"])(slideIndex, false);
  Object(_modules_button_click__WEBPACK_IMPORTED_MODULE_5__["buttonClickPrevious"])(buttonBack, slideIndex, slides, _modules_treners_carousel__WEBPACK_IMPORTED_MODULE_4__["default"]);
  Object(_modules_button_click__WEBPACK_IMPORTED_MODULE_5__["buttonClickForvard"])(buttonForward, slideIndex, slides, _modules_treners_carousel__WEBPACK_IMPORTED_MODULE_4__["default"]); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
var buttonClickPrevious = function buttonClickPrevious(buttonName, slideIndex, slides, slider) {
...
var buttonClickForvard = function buttonClickForvard(buttonName, slideIndex, slides, slider) {
  buttonName.addEventListener('click', function () {
...
var slider = function slider(slideIndex, ifClick) {
  var index = 0;
  ...
  for (var i = 0; i < slides.length; i++) {
    ...
    if (i + slideIndex > slides.length) {
      var startIndex = i + slideIndex - slides.length;
